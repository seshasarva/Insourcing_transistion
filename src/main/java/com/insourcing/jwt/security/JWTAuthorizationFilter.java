package com.insourcing.jwt.security;
...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
	...
	private static final String SECRET = "insourcePortalSecretKey";
...
//			return;
	...
	private Claims validateToken(HttpServletRequest request) {
		...
		System.out.println("the user name is-----"+request.getAttribute("username"));
